...
BANDS_KWARGS = {"cls": orm.BandsData, "tag": "bands", "with_incoming": "calculation", "project": ["*", "uuid"]}
...
qb = (
    orm.QueryBuilder()
    .append(PwCalculation, tag="calculation", filters={"uuid": {"in": list(zero_shot_uuids.values())}}, project="uuid")
    .append(**INPUT_KWARGS)
    .append(**OUTPUT_KWARGS)
)
...
qb = (
    orm.QueryBuilder()
    .append(PwBaseWorkChain, tag="calculation", filters={"uuid": {"in": list(scf_uuids.values())}}, project="uuid")
    .append(**{**INPUT_KWARGS, "edge_filters": {"label": "pw__parameters"}})
    .append(**OUTPUT_KWARGS)
)
...
qb = (
    orm.QueryBuilder()
    .append(PwBandsWorkChain, tag="calculation", filters={"uuid": {"in": list(bands_uuids.values())}}, project="uuid")
    .append(**{**INPUT_KWARGS, "edge_filters": {"label": "bands__pw__parameters"}})
    .append(**{**OUTPUT_KWARGS, "edge_filters": {"label": "band_parameters"}})
)
